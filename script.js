    ...
    allTasks.forEach((taskData) => {
      ...
      if (taskData.other) {
        newTask.innerHTML =
          ...
          taskData.time +
          "</span>" +
          "</div><hr><div class='top-line'><span class='listTitle'> Task: </span><span class='listVar'>" +
          taskData.name +
          "</span>" +
          "<span class='listTitle'> Description: </span><span class='listVar'>" +
          taskData.desc +
          ...
          taskData.department +
          "</span>" +
          "</span><span class='listTitle'> Category (Other): </span><span class='listVar'>" +
          taskData.other +
          " </span></div><div class='time-spent'><span class='listTitle'>Time Spent: </span><span class='listVar'>" +
          taskData.length +
          "</span></div>";
      } else {
        newTask.innerHTML =
          ...
          "<span>" +
          taskData.time +
          "</span></div><hr><div class='top-line'><span class='listTitle'> Task: </span><span class='listVar'>" +
          taskData.name +
          "</span>" +
          "<span class='listTitle'> Description: </span><span class='listVar'>" +
          taskData.desc +
          ...
          taskData.department +
          "</span>" +
          "</span><span class='listTitle'> Category: </span><span class='listVar'>" +
          taskData.category +
          " </span></div><div class='time-spent'><span class='listTitle'>Time Spent: </span><span class='listVar'>" +
          taskData.length +
          "</span></div>";
